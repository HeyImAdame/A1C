package net.runelite.client.plugins.aonecscheduledlogout;
...
public class A1CScheduledLogoutPlugin extends Plugin {
    ...
    @Inject
    private A1CScheduledLogoutConfig config;

    @Inject
    private KeyManager keyManager;

    @Inject
    private A1CScheduledLogoutOverlay overlay;
    ...
    @Provides
    A1CScheduledLogoutConfig provideConfig(ConfigManager configManager) {
        return (A1CScheduledLogoutConfig) configManager.getConfig(A1CScheduledLogoutConfig.class);
    }
