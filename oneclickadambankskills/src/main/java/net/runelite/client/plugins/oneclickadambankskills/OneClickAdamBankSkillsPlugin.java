...
@Slf4j
public class OneClickAdamBankSkillsPlugin extends Plugin
{
    @Inject
    ...
    @Inject
    private OneClickAdamBankSkillsConfig config;

    @Provides
    OneClickAdamBankSkillsConfig getConfig(ConfigManager configManager)
    {
        return configManager.getConfig(OneClickAdamBankSkillsConfig.class);
    }
