package net.runelite.client.plugins.oneclickadambloods;
...
@Slf4j
public class OneClickAdamBloodsPlugin extends Plugin {

    @Inject
    private Client client;

    @Inject
    private OneClickAdamBloodsConfig config;

    @Provides
    OneClickAdamBloodsConfig provideConfig(ConfigManager configManager)
    {
        return configManager.getConfig(OneClickAdamBloodsConfig.class);
    }
